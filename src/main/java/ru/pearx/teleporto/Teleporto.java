 ...
 */
@Mod(modid = Teleporto.MODID, version = Teleporto.VERSION, acceptedMinecraftVersions = "", name = Teleporto.NAME, dependencies = "required-after:pxlmc;")
public class Teleporto
{
    ...
    public static void preInit(FMLPreInitializationEvent e)
    {
        ...
        data.url = "https://minecraft.curseforge.com/projects/teleporto";
